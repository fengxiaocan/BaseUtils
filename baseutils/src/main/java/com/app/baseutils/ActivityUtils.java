...
public final class ActivityUtils {
     ...
     * @param appnameResId
     */
    public static void createLauncherIcon(Activity act, int iconResId, int appnameResId)
    {
     ...
     * @param appname   app名字
     */
    public static void createLauncherIcon(Activity act, int iconResId, String appname)
    {
     ...
     */
    public static void openActivity(Context context, Class<? extends Activity> clazz, Bundle bundle)
    {
     ...
     */
    public static void openActivityForResult(Activity activity, Class<? extends Activity> clazz,
