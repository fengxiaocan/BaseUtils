...
public class AndroidSystemUtils {
    ...
    private static String getMacAddressByWifiInfo() {
        try {
            @SuppressLint("WifiManagerLeak") WifiManager wifi = (WifiManager)Utils.getContext()
                                                                                  .getSystemService(
    ...
    public static void reboot(String reason) {
        PowerManager mPowerManager = (PowerManager)Utils.getContext()
     ...
     *
     * @param pkgCodePath the pkg code path
    ...
    private String getTotalMemory() {
        ...
        return Formatter.formatFileSize(Utils.getContext(),initial_memory);// Byte转换为KB或者MB，内存大小规格化
    }
    ...
    private String getAvailMemory() {
        ...
        am.getMemoryInfo(mi);
        return Formatter.formatFileSize(Utils.getContext(),mi.availMem);
    }
}
