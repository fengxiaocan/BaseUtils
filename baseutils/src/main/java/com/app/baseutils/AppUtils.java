...
public final class AppUtils {
    ...
    public static boolean isInstallApp(String packageName) {
        return !StringUtils.isSpace(packageName) && IntentUtils.getLaunchAppIntent(packageName) !=
                                                    null;
    }
     ...
     */
    public static void installApp(Activity activity, String filePath, String authority,
            int requestCode)
    {
    ...
    public static boolean installAppSilent(String filePath) {
        ...
        String command =
                "LD_LIBRARY_PATH=/vendor/lib:/system/lib pm install " + "" + "" + "" + filePath;
        ShellUtils.CommandResult commandResult = ShellUtils.execCmd(command, !isSystemApp(), true);
        return commandResult.successMsg != null && commandResult.successMsg.toLowerCase().contains(
                "success");
    }
    ...
    public static void uninstallApp(Activity activity, String packageName, int requestCode)
    {
        ...
        activity.startActivityForResult(IntentUtils.getUninstallAppIntent(packageName),
                requestCode);
    }
    ...
    public static Signature[] getAppSignature(String packageName) {
        ...
        try {
            PackageManager pm = Utils.getContext().getPackageManager();
            @SuppressLint("PackageManagerGetSignatures") PackageInfo pi = pm.getPackageInfo(
    ...
    public static boolean isAppForeground() {
        ActivityManager manager = (ActivityManager) Utils.getContext().getSystemService(
    ...
    public static boolean isAppForeground(String packageName) {
        return !StringUtils.isSpace(packageName) && packageName.equals(
