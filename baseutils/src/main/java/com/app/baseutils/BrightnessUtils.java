...
public final class BrightnessUtils {
    ...
    public static boolean isAutoBrightnessEnabled() {
        try {
            int mode = Settings.System.getInt(Utils.getContext().getContentResolver(),
    ...
    public static boolean setAutoBrightnessEnabled(final boolean enabled) {
        ...
        return Settings.System.putInt(Utils.getContext().getContentResolver(),
                Settings.System.SCREEN_BRIGHTNESS_MODE,
    ...
    public static int getBrightness() {
        try {
            return Settings.System.getInt(Utils.getContext().getContentResolver(),
     ...
     */
    public static boolean setBrightness(@IntRange(from = 0,
            to = 255) final int brightness)
    {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && !Settings.System.canWrite(
                Utils.getContext()))
        {
     ...
     * @param brightness 亮度值
     */
    public static void setWindowBrightness(@NonNull final Window window, @IntRange(from = 0,
            to = 255) final int brightness)
    {
