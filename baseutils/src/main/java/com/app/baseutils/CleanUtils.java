...
public final class CleanUtils {
    ...
    public static boolean cleanInternalCache() {
        return FileUtils.deleteDir(Utils.getContext().getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return FileUtils.deleteDir(Utils.getContext().getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return FileUtils.deleteDir(
                Utils.getContext().getFilesDir().getParent() + File.separator + "databases");
    }
    ...
    public static boolean cleanInternalSP() {
        return FileUtils.deleteDir(
                Utils.getContext().getFilesDir().getParent() + File.separator + "shared_prefs");
    }
    ...
    public static boolean cleanExternalCache() {
        return SDCardUtils.sdCardExist() && FileUtils.deleteDir(
