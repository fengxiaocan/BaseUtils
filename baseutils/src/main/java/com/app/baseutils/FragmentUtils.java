...
public final class FragmentUtils {
    ...
    public static Fragment addFragment(@NonNull FragmentManager fragmentManager,
            @NonNull Fragment fragment, @IdRes int containerId)
    {
    ...
    public static Fragment addFragment(@NonNull FragmentManager fragmentManager,
            @NonNull Fragment fragment, String tag, @IdRes int containerId)
    {
        return addFragment(fragmentManager, fragment, tag, containerId, false);
    }
     ...
     */
    public static Fragment addFragment(@NonNull FragmentManager fragmentManager,
            @NonNull Fragment fragment, @IdRes int containerId, boolean isHide)
    {
        return addFragment(fragmentManager, fragment, containerId, isHide, false);
    }

    public static Fragment addFragment(@NonNull FragmentManager fragmentManager,
            @NonNull Fragment fragment, String tag, @IdRes int containerId, boolean isHide)
    {
        return addFragment(fragmentManager, fragment, tag, containerId, isHide, false);
    }
     ...
     */
    public static Fragment addFragment(@NonNull FragmentManager fragmentManager,
            @NonNull Fragment fragment, @IdRes int containerId, boolean isHide, boolean isAddStack)
    {
        putArgs(fragment, new Args(containerId, isHide, isAddStack));
        return operateFragment(fragmentManager, null, fragment, null, TYPE_ADD_FRAGMENT);
    }
    ...
    {
        putArgs(fragment, new Args(containerId, isHide, isAddStack));
        return operateFragment(fragmentManager, null, fragment, tag, TYPE_ADD_FRAGMENT);
    }
    ...
    public static Fragment hideAddFragment(@NonNull FragmentManager fragmentManager,
            @NonNull Fragment hideFragment, @NonNull Fragment addFragment, @IdRes int containerId,
            boolean isHide, boolean isAddStack, SharedElement... sharedElement)
    {
        putArgs(addFragment, new Args(containerId, isHide, isAddStack));
        return operateFragment(fragmentManager, hideFragment, addFragment, null, TYPE_ADD_FRAGMENT,
                sharedElement);
    }
    ...
    public static Fragment addFragments(@NonNull FragmentManager fragmentManager,
            @NonNull List<Fragment> fragments, @IdRes int containerId, int showIndex)
    {
        ...
        for (int i = 0, size = fragments.size(); i < size; ++i) {
            ...
            if (fragment != null) {
                if (list != null) {
                    ...
                    return operateFragment(fragmentManager, null, fragment, null, TYPE_ADD_FRAGMENT,
                            list.toArray(new SharedElement[0]));
                }
            }
        }
        return fragments.get(showIndex);
    ...
    public static void removeFragment(@NonNull Fragment fragment) {
        operateFragment(fragment.getFragmentManager(), null, fragment, null, TYPE_REMOVE_FRAGMENT);
    }
    ...
    public static void removeToFragment(@NonNull Fragment fragment, boolean isIncludeSelf) {
        operateFragment(fragment.getFragmentManager(), isIncludeSelf ? fragment : null, fragment,
                null, TYPE_REMOVE_TO_FRAGMENT);
    }
     ...
     */
    public static void removeLastFragment(@NonNull FragmentManager fragmentManager) {
        List<Fragment> fragments = getFragments(fragmentManager);
        if (fragments.isEmpty()) {
            return;
        }
    ...
    public static void removeFirstFragment(@NonNull FragmentManager fragmentManager) {
        List<Fragment> fragments = getFragments(fragmentManager);
        if (fragments.isEmpty()) {
            return;
        }
    ...
    public static Fragment replaceFragment(@NonNull Fragment srcFragment,
            @NonNull Fragment destFragment, boolean isAddStack)
    {
        ...
        return replaceFragment(srcFragment.getFragmentManager(), destFragment, containerId,
                isAddStack);
    }
     ...
     */
    public static Fragment replaceFragment(@NonNull Fragment srcFragment,
            @NonNull Fragment destFragment, boolean isAddStack, SharedElement... sharedElement)
    {
        if (srcFragment.getArguments() == null) {
            return null;
        }
    ...
    public static Fragment replaceFragment(@NonNull FragmentManager fragmentManager,
            @NonNull Fragment fragment, @IdRes int containerId, boolean isAddStack)
    {
        putArgs(fragment, new Args(containerId, false, isAddStack));
        return operateFragment(fragmentManager, null, fragment, null, TYPE_REPLACE_FRAGMENT);
    }
    ...
    public static boolean popToFragment(@NonNull FragmentManager fragmentManager,
            Class<? extends Fragment> fragmentClass, boolean isIncludeSelf)
    {
        return fragmentManager.popBackStackImmediate(fragmentClass.getName(),
    ...
    {
        putArgs(fragment, new Args(containerId, false, isAddStack));
        return operateFragment(fragmentManager, null, fragment, null, TYPE_POP_ADD_FRAGMENT);
    }
    ...
    public static Fragment hideFragment(@NonNull Fragment fragment) {
        ...
        return operateFragment(fragment.getFragmentManager(), null, fragment, null,
                TYPE_HIDE_FRAGMENT);
    }
            ...
            @NonNull Fragment showFragment)
    {
        ...
        return operateFragment(showFragment.getFragmentManager(), hideFragment, showFragment, null,
    ...
    private static Args getArgs(@NonNull Fragment fragment) {
        ...
        return new Args(bundle.getInt(ARGS_ID), bundle.getBoolean(ARGS_IS_HIDE),
    ...
    private static Fragment operateFragment(@NonNull FragmentManager fragmentManager,
            Fragment srcFragment, @NonNull Fragment destFragment, String tag, int type,
            SharedElement... sharedElements)
    {
        ...
        if (tag == null) {
            tag = destFragment.getClass().getName();
        }
        ...
        switch (type) {
            case TYPE_ADD_FRAGMENT:
                ...
                ft.add(args.getInt(ARGS_ID), destFragment, tag);
            ...
            case TYPE_REPLACE_FRAGMENT:
                ft.replace(args.getInt(ARGS_ID), destFragment, tag);
                if (args.getBoolean(ARGS_IS_ADD_STACK)) {
                    ft.addToBackStack(tag);
                }
                break;
    ...
    private static Fragment getTopShowFragmentIsInStack(@NonNull FragmentManager fragmentManager,
            Fragment parentFragment, boolean isInStack)
    {
        List<Fragment> fragments = getFragments(fragmentManager);
        if (fragments.isEmpty()) {
        ...
        for (int i = fragments.size() - 1; i >= 0; --i) {
                ...
                fragment.getUserVisibleHint())
            {
                if (isInStack) {
                    if (fragment.getArguments().getBoolean(ARGS_IS_ADD_STACK)) {
                        return getTopShowFragmentIsInStack(fragment.getChildFragmentManager(),
                                fragment, true);
                    }
                } else {
                    return getTopShowFragmentIsInStack(fragment.getChildFragmentManager(), fragment,
                            false);
                }
            }
        }
     ...
     * @return 栈中同级别fragment
     */
    private static List<Fragment> getFragmentsIsInStack(@NonNull FragmentManager fragmentManager,
            boolean isInStack)
    {
    ...
    public static boolean hasFragment(@NonNull FragmentManager fragmentManager) {
        return getFragmentCount(fragmentManager) > 0;
    }
     ...
     * @return 所有fragment
     */
    public static List<FragmentNode> getAllFragmentsInStack(
     ...
     * @return 栈中所有fragment
     */
    private static List<FragmentNode> getAllFragmentsIsInStack(
            @NonNull FragmentManager fragmentManager, List<FragmentNode> result, boolean isInStack)
    {
        List<Fragment> fragments = fragmentManager.getFragments();
        if (fragments == null || fragments.isEmpty()) {
            return Collections.emptyList();
                ...
                if (isInStack) {
                    if (fragment.getArguments().getBoolean(ARGS_IS_ADD_STACK)) {
                        result.add(new FragmentNode(fragment,
                                getAllFragmentsIsInStack(fragment.getChildFragmentManager(),
                                        new ArrayList<FragmentNode>(), true)));
                    }
                } else {
                    result.add(new FragmentNode(fragment,
                            getAllFragmentsIsInStack(fragment.getChildFragmentManager(),
                                    new ArrayList<FragmentNode>(), false)));
                }
            }
        }
        return result;
     ...
     * @return 查找到的fragment
     */
    public static Fragment findFragment(@NonNull FragmentManager fragmentManager,
    ...
    public static boolean dispatchBackPress(@NonNull FragmentManager fragmentManager) {
        ...
        for (int i = fragments.size() - 1; i >= 0; --i) {
            Fragment fragment = fragments.get(i);
            if (fragment != null && fragment.isResumed() && fragment.isVisible() &&
                fragment.getUserVisibleHint() && fragment instanceof OnBackClickListener &&
