...
public final class ObjectUtils {
    ...
    public static int lenght(Collection collection) {
        if (collection == null) {
            return 0;
        }
    ...
    public static int lenght(Map map) {
        if (map == null) {
            return 0;
        }
        return map.size();
    ...
    public static boolean isEmpty(final int... obj) {
        return obj == null || obj.length == 0;
    }

    public static boolean isEmpty(final long... obj) {
        return obj == null || obj.length == 0;
    }

    public static boolean isEmpty(final float... obj) {
        return obj == null || obj.length == 0;
    }

    public static boolean isEmpty(final double... obj) {
        return obj == null || obj.length == 0;
    }

    public static boolean isEmpty(final boolean... obj) {
        return obj == null || obj.length == 0;
    }

    public static boolean isEmpty(final short... obj) {
        return obj == null || obj.length == 0;
    }

    public static boolean isEmpty(final byte... obj) {
        return obj == null || obj.length == 0;
    }
