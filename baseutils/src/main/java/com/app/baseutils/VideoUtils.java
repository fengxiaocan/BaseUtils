...
public class VideoUtils {
    ...
    public static int getVideoTimeLength(String path) {
        ...
        try {
            ...
            String duration = mmr.extractMetadata(
                    MediaMetadataRetriever.METADATA_KEY_DURATION); // 播放时长单位为毫秒
    ...
    public static boolean isVideo(String filePath) {
        ...
        return path.endsWith(".AVI") || path.endsWith(".RM") || path.endsWith(".MPEG") ||
               path.endsWith(".MPG") || path.endsWith(".MP4") || path.endsWith(".MEPG4") ||
