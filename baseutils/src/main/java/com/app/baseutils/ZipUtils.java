...
public final class ZipUtils {
     ...
     * @throws IOException IO错误时抛出
     */
    private static boolean zipFile(File resFile, String rootPath, ZipOutputStream zos,
    ...
    public static boolean unzipFile(String zipFilePath, String destDirPath) throws IOException {
        return unzipFile(FileUtils.getFileByPath(zipFilePath),
     ...
     * @throws IOException IO错误时抛出
     */
    public static List<File> unzipFileByKeyword(String zipFilePath, String destDirPath,
            ...
            throws IOException
    {
        ...
        while (entries.hasMoreElements()) {
            ...
            if (StringUtils.isEmpty(keyword) || FileUtils.getFileName(entryName)
                                                         .toLowerCase()
    ...
    public static void zipFile(InputStream is, File osFile) throws IOException {
        // 包装输出流
        GZIPOutputStream gos = new GZIPOutputStream(new FileOutputStream(osFile));
     ...
     * @throws IOException
     */
    public static void unZipFile(InputStream is, File osFileDir) throws IOException {
