...
public final class RegexConstants {
     ...
     * 正则：URL编码后的字符串
     */
    public static final String REGEX_ENCODE_URL = "(%\\w\\w)+";
    /**
     * 正则：汉字
     */
     ...
     * 正则:匹配URL中的img src
     */
    public static final String REGEX_URL_IMASRC =
            "<img\\b[^>]*?\\bsrc[\\s]*=[\\s]*[\"']?[\\s]*(?<imgUrl>[^\"'>]*)[^>]*?/?[\\s]*>";

    /**
     * 正则:提取http
     */
    public static final String REGEX_URL_SRC = "http[\\s]*[\"']?[\\s]*(?<imgUrl>[^\"'>]*)";

    public static final String REGEX_HTTP_URL = "(https?|ftp|file)://[-A-Za-z0-9+&@#/%?=~_|!:,.;]+[-A-Za-z0-9+&@#/%=~_|]";

    public static final String REGEX_IMG_SRC = "src=('|\").+('|\")";
    /**
     * 提取html中加粗的文本
     */
    public static final String REGEX_URL_STRONG = "<strong>(.|\\n)+</strong>";
